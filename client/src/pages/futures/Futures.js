      ...
      <div>
        ...
        style={{ background: "#fff", color: "#000" }} >
          <div className="about_us__quotex">
            <h1 className="head" style={{ color: "#0bb791" }}>Futures Trading </h1>
            <h3>Trading at it's peak</h3>

            <p
            style={{  color: "#000" }}>
              Are you ready to explore the exciting world of futures trading?
              Avtroncrest provides you with a comprehensive platform to trade
              futures contracts on various commodities, indices, and currencies.
              Whether you are an experienced futures trader or a novice looking
              to expand your investment portfolio, we offer the tools,
              resources, and support to help you navigate the futures market
              with confidence.
            </p>
          </div>
          <div className="dol"
          style={{ background: "#fff", color: "#000" }}>
            <img src={futures} alt="" className="about_us__image" />
          </div>
        </div>
        ...
        <div class="container about_us__modern main__reviews">
          ...
          <div class="about_us__modern-items">
            <p
              ...
              style={{ width: "100%" }}
            >
              Diverse Range of Futures: At Avtroncrest, we offer a wide
              selection of futures contracts across different asset classes.
              From commodities like gold, oil, and agricultural products to
              indices representing major global markets, you'll find a variety
              of futures options to suit your trading preferences.
            </p>
            <p
              class="about_us__modern-item"
              dir="auto"
              style={{ width: "100%" }}
            >
              Advanced Trading Tools: Our platform is equipped with advanced
              trading tools designed specifically for futures trading. Access
              real-time market data, advanced charting features, and technical
              analysis tools to make well-informed trading decisions. With our
              robust order execution capabilities, you can enter and exit
            ...
            <p
              ...
              style={{ width: "100%" }}
            >
              Risk Management: Managing risk is crucial in futures trading, and
              we provide you with the necessary risk management tools to protect
              your capital. Set stop-loss orders, monitor margin requirements,
              and utilize our risk management features to ensure responsible and
              disciplined trading.
            </p>
            <p
              class="about_us__modern-item"
            ...
            >
              ...
              looking to enhance your skills, P Avtroncrest offers a wealth of
